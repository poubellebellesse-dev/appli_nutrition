...
>
> **Réellement ouvertes au 2026-08-10 : 2, 5, 6, 11, 52, 58, 65, 66, 67, 68 — DIX.** Compté sur les
...
> bloque le code ». **La 65 bloque le code** : la réservation de matériel du mode cuisine attend deux
> colonnes dans `catalog/`, pas du code. Et la **67** est un chantier en cours (D3, D4). La phrase
> était vraie le 2026-08-08 ; cinq décisions se sont ouvertes depuis.
>
> ⚠️ **LE DÉCOUPAGE « attend un élément extérieur / demande un arbitrage » RESTE À REFAIRE SUR LES
> DIX** — il n'est ci-dessous conservé que pour les cinq d'origine (2 et 5 attendent une maquette,
