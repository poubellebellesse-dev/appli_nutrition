...
//
// ⚠️ DEUX SOURCES, UN SEUL GESTE. Les deux demandes du lot du 2026-08-01 — « rajouter en manuel la
...
// fonctionnalités là où il y en a une.
//
...
export function ChoisirPlat({
  ...
  return (
    <Panneau titre={`Choisir un plat — ${libelleCreneau}`} onFermer={onFermer}>
      {/* Les deux sources. `role="tablist"` plutôt que deux boutons libres : un lecteur d'écran doit
          entendre qu'il s'agit d'un choix EXCLUSIF entre deux vues du même contenu. */}
      <div role="tablist" aria-label="D’où partir" className="flex gap-2">
